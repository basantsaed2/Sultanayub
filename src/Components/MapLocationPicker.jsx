...
/* eslint-disable react/no-unused-prop-types */ // لو فيه أي warnings تانية عن props مش مستخدمة
...
const [locationName, setLocationName] = useState(() => {
  ...
  // If value is an object but has no address, you might want to use a default or reverse geocode immediately.
  if (typeof value === 'object' && value.address) return value.address;
  // Added a fallback for objects without an address property
  if (typeof value === 'object') {
    // You could also trigger a reverse geocode here if you have lat/lng
    // For now, let's just return an empty string or a generic name.
    return ""; // Or "Coordinates Selected" or a similar default
  }
  return "";
});
  // Initialize map
