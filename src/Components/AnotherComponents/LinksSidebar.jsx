...
const LinksSidebar = () => {
  ...
  const [isActiveProductSetupIcon, setIsActiveProductSetupIcon] =
    useState(false);
  ...
  const [isActiveAutomaticPayment, setIsActiveAutomaticPayment] =
    useState(false);
  /* Sound */
  ...
  const [isActiveOrdersPaymentIcon, setIsActiveOrdersPaymentIcon] =
    useState(false);
  ...
  const [isActiveBusinessSetupIcon, setIsActiveBusinessSetupIcon] =
    useState(false);
  ...
  const [isActiveOrdersProcessing, setIsActiveOrdersProcessing] =
    useState(false);
  const [isActiveOrdersOutForDelivery, setIsActiveOrdersOutForDelivery] =
    useState(false);
  ...
  useEffect(() => {
    ...
    if (
      result === "/dashboard/setup_product" &&
      !pathName.startsWith("/dashboard/setup_product/product")
    ) {
  ...
  useEffect(() => {
    if (
      ...
      !["/dashboard/taxes/all_taxes", "/dashboard/taxes/tax_type"].some(
  ...
  const handleClickLogOrders = useCallback(() => {
    handleStateLinks();

    setIsOpenOrders(true);
    setIsActiveOrders(true);
    setIsActiveOrdersIcon(true);
    setIsActiveLogOrders(true);
  }, []);
  useEffect(() => {
    const part = pathName.split("/");
    const result = part.slice(0, 4).join("/");
    if (result == "/dashboard/orders/log") {
      handleClickLogOrders();
    }
  }, [location]);
  ...
  useEffect(() => {
    ...
    const result = part.slice(0, 5).join("/");
    if (
      result.startsWith("/dashboard/orders/details/") ||
      result.startsWith("/dashboard/orders/invoice/")
    ) {
      handleStateLinks();
  ...
  useEffect(() => {
    if (
      ...
      !["/dashboard/users/customers", "/dashboard/users/admins"].some((path) =>
      ...
      {auth?.userState?.user_positions?.name === "Super Admin" ? (
        <div className="LinksSidebar w-full flex flex-col items-center justify-start gap-y-3">
          ...
          <div className="w-full flex flex-col">
            ...
            <div
              className={`${
                isOpenOrders && hideSide ? "h-auto" : "h-0 "
              ...
              <ul className="list-disc w-full pl-2 transition-all duration-700 flex flex-col gap-y-2">
                ...
                <Link to={"orders/pending"} onClick={handleClickOrdersPending}>
                  ...
                  >
                    <span>Pending</span>
                    <span className="bg-cyan-300 text-cyan-700 px-1 text-sm font-TextFontMedium rounded-2xl">
                      {lengths.ordersPending || 0}
                    </span>
                  </li>
                </Link>
                <Link
                  to={"orders/confirmed"}
                  onClick={handleClickOrdersConfirmed}
                >
                  <li
                    className={`${
                  ...
                  >
                    <span>Confirmed</span>
                    <span className="bg-cyan-300 text-cyan-700 px-1 text-sm font-TextFontMedium rounded-2xl">
                      {lengths.ordersConfirmed || 0}
                    </span>
                  </li>
                </Link>
                <Link
                  to={"orders/processing"}
                  onClick={handleClickOrdersProcessing}
                >
                  <li
                    className={`${
                  ...
                  >
                    ...
                    <span className="bg-cyan-300 text-cyan-700 px-1 text-sm font-TextFontMedium rounded-2xl">
                      {lengths.ordersProcessing || 0}
                    </span>
                  </li>
                </Link>
                <Link
                  to={"orders/out_for_delivery"}
                  onClick={handleClickOrdersOutForDelivery}
                >
                  <li
                    className={`${
                  ...
                  >
                    ...
                    <span className="bg-cyan-300 text-cyan-700 px-1 text-sm font-TextFontMedium rounded-2xl">
                      {lengths.ordersOutForDelivery || 0}
                    </span>
                  </li>
                </Link>
                <Link
                  to={"orders/delivered"}
                  onClick={handleClickOrdersDelivered}
                >
                  <li
                    className={`${
                  ...
                  >
                    <span>Delivered</span>
                    <span className="bg-cyan-300 text-cyan-700 px-1 text-sm font-TextFontMedium rounded-2xl">
                      {lengths.ordersDelivered || 0}
                    </span>
                  </li>
                </Link>
                <Link
                  to={"orders/returned"}
                  onClick={handleClickOrdersReturned}
                >
                  <li
                    className={`${
                ...
                <Link to={"orders/failed"} onClick={handleClickOrdersFailed}>
                  ...
                  >
                    ...
                    <span className="bg-cyan-300 text-cyan-700 px-1 text-sm font-TextFontMedium rounded-2xl">
                      {lengths.ordersFailed || 0}
                    </span>
                  </li>
                </Link>
                <Link
                  to={"orders/canceled"}
                  onClick={handleClickOrdersCanceled}
                >
                  <li
                    className={`${
                  ...
                  >
                    <span>Canceled</span>
                    <span className="bg-cyan-300 text-cyan-700 px-1 text-sm font-TextFontMedium rounded-2xl">
                      {lengths.ordersCanceled || 0}
                    </span>
                  </li>
                </Link>
                <Link
                  to={"orders/schedule"}
                  onClick={handleClickOrdersSchedule}
                >
                  <li
                    className={`${
                  ...
                  >
                    <span>Schedule</span>
                    <span className="bg-cyan-300 text-cyan-700 px-1 text-sm font-TextFontMedium rounded-2xl">
                      {lengths.ordersSchedule || 0}
                    </span>
                  </li>
                </Link>
                <Link
                  to={"orders/log"}
                  onClick={handleClickLogOrders}
                >
                  <li
                    className={`${
                      isActiveLogOrders
          ...
          >
            <div className="flex items-center gap-x-2">
              <CategoryIcon
                isActive={isActiveCategoryIcon || isActiveCategory}
              />
              <span
                className={`
                                          ${hideSide ? "block" : "hidden"}
          ...
          <div className="w-full flex flex-col">
            ...
            >
              <div className="flex items-center gap-x-2">
                <ProductIcon
                  isActive={isActiveProductSetupIcon || isActiveProductSetup}
                />
                <span
                  className={`
                                          ${hideSide ? "block" : "hidden"}
            ...
            <div
              className={`${
                isOpenProductSetup && hideSide ? "h-20" : "h-0"
              } overflow-hidden flex items-start justify-end  w-full transition-all duration-700`}
            >
          ...
          >
            <div className="flex items-center gap-x-2">
              <PiFlagBanner
                className={`${
                  isActiveBannersIcon || isActiveBanners
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-2xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <RiVipDiamondLine
                className={`${
                  isActiveAddonsIcon || isActiveAddons
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-2xl`}
              />
          ...
          <div className="w-full flex flex-col">
            ...
            >
              <div className="flex items-center gap-x-2">
                <HiReceiptTax
                  className={`${
                    isActiveTaxesIcon || isActiveTaxes
                      ? "text-[#9E090F]"
                      : "text-[#fff]"
                  } text-2xl`}
                />
          ...
          >
            <div className="flex items-center gap-x-2">
              <MdOutlinePayments
                className={`${
                  isActiveOrdersPaymentIcon || isActiveOrdersPayment
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-2xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <MdOutlineDeliveryDining
                className={`${
                  isActiveDeliveryManIcon || isActiveDeliveryMan
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-3xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <IoMdGitBranch
                className={`${
                  isActiveBranchesIcon || isActiveBranches
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-3xl`}
              />
          ...
          <div className="w-full flex flex-col">
            ...
            <div
              className={`${
                isOpenSetting && hideSide ? "h-17" : "h-0 "
              } overflow-hidden flex items-start justify-end  w-full transition-all duration-700`}
            >
              <ul className="list-disc w-full pl-10 transition-all duration-700 flex flex-col gap-y-2">
                ...
                <Link
                  to={"setting/automatic_payment"}
                  onClick={handleClickAutomaticPayment}
                >
                  <li
                    className={`${
                ...
                <Link
                  to={"setting/resturant_time"}
                  onClick={handleClickResturantTime}
                >
                  <li
                    className={`${
                ...
                <Link
                  to={"setting/cancel_time"}
                  onClick={handleClickCancelTime}
                >
                  <li
                    className={`${
                      isActiveCancelTime
          ...
          >
            <div className="flex items-center gap-x-2">
              <MdOutlineSettingsInputComposite
                className={`${
                  isActiveBusinessSetupIcon || isActiveBusinessSetup
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-2xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <TbBorderAll
                className={`${
                  isActiveDealsIcon || isActiveDeals
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-3xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <MdDiscount
                className={`${
                  isActiveOffersIcon || isActiveOffers
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-3xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <BiSolidCoupon
                className={`${
                  isActiveCouponIcon || isActiveCoupon
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-3xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <IoLanguage
                className={`${
                  isActiveLanguagesIcon || isActiveLanguages
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-2xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <TbReportSearch
                className={`${
                  isActiveDealOrderIcon || isActiveDealOrder
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-2xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <BiSolidOffer
                className={`${
                  isActiveBuyOfferIcon || isActiveBuyOffer
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-2xl`}
              />
          ...
          >
            <div className="flex items-center gap-x-2">
              <BiSolidDiscount
                className={`${
                  isActiveDiscountIcon || isActiveDiscount
                    ? "text-[#9E090F]"
                    : "text-[#fff]"
                } text-2xl`}
              />
            ...
            <>
              <div className="w-full flex flex-col">
                ...
                >
                  <div className="flex items-center gap-x-2">
                    <OrderIcon
                      isActive={isActiveOrdersIcon || isActiveOrders}
                    />
                    <span
                      className={`
                                   ${hideSide ? "block" : "hidden"}
                ...
                <div
                  className={`${
                    isOpenOrders && hideSide ? "h-[29rem]" : "h-0 "
                  }  overflow-hidden flex items-start justify-end  w-full transition-all duration-700`}
                >
                  <ul className="list-disc w-full pl-2 transition-all duration-700 flex flex-col gap-y-2">
                    <Link to={"orders/all"} onClick={handleClickOrdersAll}>
                    ...
                    <Link
                      to={"orders/pending"}
                      onClick={handleClickOrdersPending}
                    >
                      <li
                        className={`${
                          isActiveOrdersPending
                    ...
                    <Link
                      to={"orders/failed"}
                      onClick={handleClickOrdersFailed}
                    >
                      <li
                        className={`${
                          isActiveOrdersFailed
              ...
              <div className="w-full flex flex-col">
                ...
                >
                  <div className="flex items-center gap-x-2">
                    <ProductIcon
                      isActive={
                        isActiveProductSetupIcon || isActiveProductSetup
                      }
                    />
                    <span
                      className={`
