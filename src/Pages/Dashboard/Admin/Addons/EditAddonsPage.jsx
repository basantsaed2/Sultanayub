...
const EditAddonsPage = () => {
  ...
  const {
    refetch: refetchAddonsEdit,
    loading: loadingAddonsEdit,
    data: dataAddonsEdit,
  } = useGet({ url: `${apiUrl}/admin/addons/item/${addonId}` });
  ...
  const handleAddonAdd = (e) => {
    ...
    // }
    if (!addonPrice) {
      auth.toastError(t("please Enter Addon Price"));
      return;
    }
                          ...
                          onChange={(e) => {
                            ...
                            setAddonsName((prev) => {
                              ...
                              updatedNames[index] = {
                                ...
                                tranlation_id:
                                  tap?.id ||
                                  updatedNames[index]?.tranlation_id ||
                                  "-", // Use tap.id if available, or fallback to existing
                                addon_name: inputValue, // Update addon_name with input value
                                tranlation_name:
                                  tap?.name ||
                                  updatedNames[index]?.tranlation_name ||
                                  "Default Name", // Use tap.name or existing value
                              };
