...
const EditPreparationMan = () => {
    const { preparationManId, branchId } = useParams();
    ...
    useEffect(() => {
        if (dataPreparationMan && dataPreparationMan.data) {
            ...
            setPrintStatus(preparationMan.print_status || 0);
            setPrintIp(preparationMan.print_ip || "");
            setPrintPort(preparationMan.print_port || "");
            setPrintName(preparationMan.print_name || "");
            setPrintType(preparationMan.print_type === "network" ? { value: "network", label: t("Network") } : { value: "usb", label: t("USB") });
        }
    }, [dataPreparationMan, t]);
