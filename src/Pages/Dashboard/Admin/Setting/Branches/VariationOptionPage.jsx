...
//                                                                              <Link to={`/dashboard/setting/branches/branch_category/${branchId}/category_product/${branch.id}`} className='text-mainColor text-xl border-b-2 border-mainColor font-TextFontSemiBold cursor-pointer'>
//                                                                                     View
//                                                                              </Link>
//                                                                       </td>
//                                                                </tr>
