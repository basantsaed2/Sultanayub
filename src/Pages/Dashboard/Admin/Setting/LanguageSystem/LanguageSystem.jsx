...
const LanguageSystem = () => {
    ...
    const handleLangChange = async (key, currentValue) => {
        ...
        const success = await postData(formData, t("Language updated successfully"));
    ...
    return (
        <section className="w-full p-6 bg-white rounded-xl shadow-sm border">
            <h2 className="text-2xl font-TextFontSemiBold text-mainColor mb-8">
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div className="flex items-center gap-4">
                        ...
                        />
                        <div>
                            <p className="font-TextFontMedium text-thirdColor">{t("Brista App Language")}</p>
                            <p className="text-sm text-gray-500">
                                {bristaLang === 'ar' ? t("Arabic") : t("English")}
                            </p>
                        </div>
                    </div>
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${bristaLang === 'ar' ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'}`}>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div className="flex items-center gap-4">
                        ...
                        />
                        <div>
                            <p className="font-TextFontMedium text-thirdColor">{t("Kitchen Display Language")}</p>
                            <p className="text-sm text-gray-500">
                                {kitchenLang === 'ar' ? t("Arabic") : t("English")}
                            </p>
                        </div>
                    </div>
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${kitchenLang === 'ar' ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'}`}>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div className="flex items-center gap-4">
                        ...
                        />
                        <div>
                            <p className="font-TextFontMedium text-thirdColor">{t("Cashier App Language")}</p>
                            <p className="text-sm text-gray-500">
                                {cashierLang === 'ar' ? t("Arabic") : t("English")}
                            </p>
                        </div>
                    </div>
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${cashierLang === 'ar' ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'}`}>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div className="flex items-center gap-4">
                        <Switch
                            ...
                            handleClick={() => handleLangChange('preparation_lang', preparationLang)}
                            disabled={loadingPost}
                        />
                        <div>
                            <p className="font-TextFontMedium text-thirdColor">{t("Preparation Screen Language")}</p>
                            <p className="text-sm text-gray-500">
                                {preparationLang === 'ar' ? t("Arabic") : t("English")}
                            </p>
                        </div>
                    </div>
                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${preparationLang === 'ar' ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'}`}>
            ...
            <div className="mt-8 text-sm text-gray-500 text-center">
                {t("These settings control the default language for each system module.")}
            </div>
        </section>
    );
};
