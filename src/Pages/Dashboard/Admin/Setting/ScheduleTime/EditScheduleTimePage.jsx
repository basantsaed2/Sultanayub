...
const EditScheduleTimePage = ({ update, setUpdate }) => {
    ...
    const { refetch: refetchSchedule, loading: loadingSchedule, data: dataSchedule } = useGet({ url: `${apiUrl}/admin/settings/schedule_time_slot/item/${scheduleId}` });
    ...
    useEffect(() => {
        if (dataSchedule && dataSchedule.schedule_time_slot && dataSchedule.slot_names) {
             const newTimesNames = [];
    ...
    const handleCategoryAdd = (e) => {
        ...
        postData(formData, 'Schedule Time Updated Success');
    };
    return (
        <>
