...
const EditExpensesCategory = () => {
    ...
    useEffect(() => {
        if (dataExpensesCategory && dataExpensesCategory.category) {
            const categories = dataExpensesCategory.category;
    ...
    const handleReset = () => {
        if (dataExpensesCategory && dataExpensesCategory.categories) {
            const category = dataExpensesCategory.categories;
    ...
    const handleUpdate = (e) => {
        ...
        if (!name) {
            auth.toastError(t("Enter Expenses Category Name"));
            return;
        }
    ...
    return (
        <>
            {loadingPost || loadingExpensesCategory ? (
