...
const EditProductPage = () => {
  ...
  useEffect(() => {
    if (productEdit) {
      ...
      const formattedDescription = productEdit?.product_descriptions?.map(description => ({
      ...
      // Handle extras data
      const formattedExtras = productEdit?.extras?.map(extra => ({
      ...
      const formattedVariations = productEdit?.variation?.map(variation => ({
        ...
        options: variation.options?.map(option => ({
          ...
          extra: option.extra?.map(extraItem => ({
